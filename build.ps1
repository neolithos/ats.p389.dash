...
$rootPath = "D:\ATS\peterbilt_389_dashboard";
$compress = @(
	"icon.jpg",
	"manifest.sii",
	"mod_description.txt"
...
$targetZip = Join-Path $rootPath .\bin\peterbilt_389_dashboard_neo.zip;
...
Copy-Item $targetZip -Destination "C:\Users\Stein\Documents\American Truck Simulator\mod\peterbilt_389_dashboard_neo.scs"
